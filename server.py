...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "\n"
        "Due-diligence resources — access depends on client capability:\n"
        "\n"
        "Clients with native resource support (claude.ai, Claude Desktop, Goose):\n"
        "  Use resources/read with URIs:\n"
        "  company://dd/{company_number}/profile\n"
        "  company://dd/{company_number}/officers\n"
        "  company://dd/{company_number}/psc\n"
        "  disqualification://dd/{officer_id}\n"
        "  charity://dd/{charity_number}/profile\n"
        "\n"
        "Tool-only clients (Claude Code, Cursor, ChatGPT) — use dd_read_resource tool:\n"
        ...
        "\n"
        "Use dd_list_resources to confirm available URIs."
    ),
)
